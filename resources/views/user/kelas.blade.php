...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            .text-start {
                font-size: 0.875rem; /* Ukuran font lebih kecil pada layar mobile */
            }
        }
    ...
    <section class="py-5">
        ...
        @endif
            <div class="row gx-4 gx-lg-5 row-cols-4 justify-content-center">
                ...
                <div class="col-6 col-md-4 col-lg-3 mb-5" data-aos="zoom-in" data-aos-delay="100">
