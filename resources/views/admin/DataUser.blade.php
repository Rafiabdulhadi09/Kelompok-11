                                ...
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a type="submit" class="btn btn-info" href="{{ route('admin.dataUser.edit', $user->id) }}">
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger mx-1" onclick="confirmDelete(event, {{ $user->id }})" >
