          ...
          @include('component.truefalse')
            <div class="card shadow-sm mt-4">
              <div class="card-header bg-primary text-white">
                  <h5 class="card-title mb-0">Edit Data Trainer</h5>
              </div>
              <div class="card-body">
                <form action="{{ route('admin.dataTrainer.update', $user->id) }}" method="post" class="mx-1 mx-md-4">
                  ...
                  <div class="mb-4">
                    ...
                    <input type="text" name="name" value="{{ $trainer->name }}" id="nama" class="form-control" required />
                  </div>

                  <div class="mb-4">
                    <label for="email" class="form-label">Masukan Email</label>
                    <input type="email" name="email" value="{{ $trainer->email }}" id="email" class="form-control" required />
                  </div>
