...
@include('component.NavbarAdmin')
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form action="{{ route('admin.data-trainer.search') }}" method="GET" class="input-group align-right" >
