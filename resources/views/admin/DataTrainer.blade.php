                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center">
                                                <a type="submit" class="btn btn-info mx-1" href="{{ route('admin.dataTrainer.edit', $trainer->id) }}">
                                                ...
                                                <form id="delete-form-{{ $trainer->id }}" action="{{ route('admin.DataTrainer.destroy', $trainer->id) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-danger mx-1" onclick="confirmDelete(event, {{ $trainer->id }})">
