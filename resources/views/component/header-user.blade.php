      ...
      <ul>
        ...
        <li class="dropdown">
          <a href="#">
            ...
            <img class="img-profile rounded-circle position-absolute top-50 start-50 translate-middle" src="{{ asset('storage/profile_images/' . $user->image) }}" alt="{{ $user->name }}" width="35">
            @else
